...
- game/scripts/combat/battle_state.gd — `_compute_effective_stats()` (bakes PartyState.get_equipment_bonus and Stat Capsule gains into effective_stats at battle start, which is what the verification found already implemented)

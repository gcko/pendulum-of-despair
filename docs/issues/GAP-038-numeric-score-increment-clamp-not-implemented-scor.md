...
- game/scripts/core/cutscene_handler.gd — `_on_cutscene_score_increment()` (the cutscene-path handler)
- game/scripts/util/dialogue_consequences.gd — `connect_overlay()` (the exploration-path handler)

...
| [GAP-086](GAP-086-inventory-helpers-gd-placed-in-scripts-autoload-bu.md) | Code structure | LOW | S | resolved (Issue #236) | inventory_helpers.gd moved to scripts/util/; scripts/autoload/ now holds only the 6 registered singletons |

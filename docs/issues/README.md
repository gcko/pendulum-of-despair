...
| [GAP-087](GAP-087-multiple-core-files-exceed-the-stated-400-line-str.md) | Code structure | LOW | L | partial (decomposed; 4 files still over 400, line-count table re-run — closes #319/#343) | Multiple core files exceed the stated ~400-line structure target |
...
| [GAP-089](GAP-089-design-docs-magic-md-abilities-md-still-mostly-com.md) | Docs | LOW | M | partial (magic.md COMPLETE; 10 ability magnitudes still open, #321) | magic.md numeric balance closed; abilities.md still MOSTLY COMPLETE — 10 ability damage/healing magnitudes open while JSON + battle already consume the data |

...
- game/scripts/combat/battle_setup.gd — `apply_atb_config()` (reads PartyState.get_config into set_atb_mode/set_battle_speed — the wiring this gap asked for. battle_manager.gd, cited here before, now only calls it)

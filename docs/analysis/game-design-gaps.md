...
- [x] Overworld encounter table per terrain type (12 overworld zone types at the time; 15 today, plus dungeon tiers, with danger counter increments)
...
- [x] Mount/chocobo equivalent — Ley Stag mount: spirit-bonded, 2x speed, no encounters, terrain restricted (no dense Thornmere/water/mountains/towns), mid-Act II unlock at Roothollow (requires `duskfen_alliance` + Torren in party; `stag_bonded` flag). Lost in Interlude, returns Act III (grey-tinged, Pallor Wastes restricted).
...
- [x] Terrain encounter rate modifiers — already defined in geography.md Section 5 (danger counter increments per terrain zone (13 canonical rows)); overworld.md references, does not duplicate
...
**Status:** COMPLETE
**Priority:** P2
**Files:** `docs/story/script/` — README.md, act-i.md, act-ii-part-1.md, act-ii-part-2.md, interlude.md, act-iii.md, act-iv-epilogue.md, npc-ambient.md, battle-dialogue.md

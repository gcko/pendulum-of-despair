...
| Abilities & magic | `abilities.md` (1,040), `magic.md` (1,684) |
...
| Architecture | `docs/plans/technical-architecture.md` (1,239) |
...
- [x] Weapons JSON: 61 weapons with stats, equippable_by, tier, element, special, bonus_stats
- [x] Armor JSON: 50 armor pieces (20 head + 30 body) with stats, tier, armor_class
- [x] Accessories JSON: 60 accessories
...
| 2026-04-22 | 3.8 Audio Integration | NOT STARTED → COMPLETE. 16-player AudioManager (24-channel design budget): dual-track crossfade (music + ambient), 12-slot SFX pool with 8-tier priority stealing, 7 mix contexts (overworld/town/dungeon/narrative_dungeon/pallor/battle/cutscene), 3 AudioBuses (Music/SFX/Ambient) with context-aware mixing model, battle enter/exit with state resume. Wired cutscene_handler, exploration, and config screen. 68 placeholder .ogg files (silent, vorbis). 53 GUT tests. | — |

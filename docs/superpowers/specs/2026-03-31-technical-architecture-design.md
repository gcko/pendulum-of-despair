...
Extends dialogue-system.md's 7-field format with `conditions` for
flag-gated party-aware dialogue.
...
Flags are serialized as part of save data (world.eventFlags in

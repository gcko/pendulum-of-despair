...
> **Dated record (2026-03-18) — not maintained.** Paths, line numbers, counts
...
5. **Silence is sacred.** Narrative true silence (zero audio, sustained
   ...
   (5s) and before the bird call at Cael's sacrifice (3s). Other moments
   where music stops (Game Over, the Betrayal, Pallor Wastes biome
   transition) retain ambient sound or transition to drone within seconds
   — these are music-stops, not true silence. The Pallor Wastes transition
   has a brief gap before the drone fades in over 5 seconds (per
   biomes.md), but this is a transition effect, not a narrative beat.
...
**Terminology note:** `biomes.md` defines a 3-stage Pallor overlay system
(Stages 1-3) for visual corruption; `dynamic-world.md` uses Stages 0-3

...
> **Dated record (2026-03-31) — not maintained.** Paths, line numbers, counts
...
> **Gap:** 4.1 Core Game Design Document (GDD Overview)
> **Status:** Spec complete, pending implementation
> **Date:** 2026-03-31

## Overview

Create a 2-3 page entry-point document (`docs/story/gdd-overview.md`)
that consolidates the game's pitch, systems, scope, and document index
into a single reference. All content already exists across 35+ design
docs — this is a synthesis task, not new design work.

**Dual audience:** Page 1 works as a stakeholder pitch. Pages 2-3
work as developer onboarding. The document links to detailed docs
for deep dives.
...
| Cael | Commander → betrayer | Charismatic but wounded by grief. Dies closing the Pallor's door. |
...
- **Damage:** ATK²/6 - DEF (physical), MAG×power/4 - MDEF (magic)
...
## 3. Scope & Reference (Page 3)

### Content Volume

| Category | Count | Source |
|----------|-------|--------|
| Party members | 6 playable + 2 guests | characters.md |
| Regular enemies | 204 | bestiary/ |
| Bosses | 31 (+ 1 scripted loss) | bestiary/bosses.md |
| Palette-swap families | 32 | bestiary/palette-families.md |
| Consumable items | 33 | items.md |
| Equipment (weapons) | 56 | equipment.md |
| Equipment (armor) | 49 | equipment.md |
| Accessories | 42 | equipment.md |
| Crafting materials | 72 | items.md |
| Key items | 26 | items.md |
| Ley Crystals | 18 | progression.md |
| Towns/settlements | 10+ | locations.md |
| Dungeons | 13+ | dungeons-world.md, dungeons-city.md |
| Script lines | ~6,300 | script/ |
| Narrative scenes | 44 | script/ |
| Sidequests | 25-30 | sidequests.md |
...
**Narrative:**
- `outline.md` — story outline, act structure, themes
- `events.md` — event flags, story triggers, branching
- `characters.md` — party members, arcs, stat growth
- `npcs.md` — NPC roster, dialogue rules
- `world.md` — world setting, factions, history
- `script/` — full dialogue script (8 files, ~6,300 lines)

**Combat & Progression:**
- `combat-formulas.md` — damage, ATB, encounters, row system
- `progression.md` — leveling, Ley Crystals, milestones
- `abilities.md` — character abilities, Arcanite Forging
- `magic.md` — spell system
- `bestiary/` — enemy stat tables, boss AI scripts (8 files)
- `difficulty-balance.md` — balance philosophy, anti-frustration

**World & Exploration:**
- `locations.md` — location catalog, act availability
- `dungeons-world.md` — dungeon layouts, encounter tables
- `dungeons-city.md` — city dungeon layouts
- `geography.md` — overworld map, terrain types
- `overworld.md` — traversal, Mode 7, save points
- `transport.md` — rail, ferry, Ley Stag mount
- `city-valdris.md`, `city-carradan.md`, `city-thornmere.md` — city layouts

**Items & Economy:**
- `items.md` — consumables, materials, key items
- `equipment.md` — weapons, armor, accessories
- `economy.md` — shop inventories, pricing, gold pacing
- `crafting.md` — Arcanite Forging system

**Presentation:**
- `visual-style.md` — art direction, palettes, Pallor corruption
- `ui-design.md` — battle screen, menus, save/load UI
- `music.md` — score, leitmotifs, corruption audio
- `dialogue-system.md` — text box mechanics, sprite emotions
- `biomes.md` — terrain palettes, environmental rules

**Systems:**
- `save-system.md` — save/load, auto-save, death recovery, rest items
- `accessibility.md` — display scaling, color-blind, Patience Mode, motion
- `dynamic-world.md` — act-based world state changes
- `sidequests.md` — sidequest catalog
- `postgame.md` — post-game content, boss rush, completion tracking

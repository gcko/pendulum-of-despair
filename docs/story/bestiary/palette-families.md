...
**Base:** Tomb Mite (Lv 2, Beast, Trivial)
**Planned Tiers:** 3
...
> Three tiers is sufficient; they never become Pallor-corrupted.

---

## Dead Family

**Base:** Restless Dead (Lv 3, Undead, Trivial)
**Planned Tiers:** 4
...
**Base:** Unstable Crystal (Lv 3, Elemental, Low)
**Planned Tiers:** 3
...
**Base:** Mine Shade (Lv 4, Spirit, Low)
**Planned Tiers:** 4
...
**Base:** Bone Warden (Lv 4, Undead, Low)
**Planned Tiers:** 4
...
> slow fights with Despair Aura.

---

## Wisp Family

**Base:** Ember Wisp (Lv 5, Elemental, Low)
**Planned Tiers:** 3
...
**Base:** Ember Drake (Lv 8, Beast, Dangerous)
**Planned Tiers:** 4

| Tier | Name | Lv | Type | Element Shift | New Abilities | Threat |
|------|------|----|------|---------------|---------------|--------|
| 1 | Ember Drake | 8 | Beast | — | Flame Breath (cone AoE, 1-turn charge), Tail Swipe, Pounce (back-row) | Dangerous |
| 2 | Frost Drake | 22 | Beast | Weak->Flame, Resist->Frost | +Ice Breath (cone AoE), +Glacial Armor (DEF up) | Dangerous |
| 3 | Thunder Drake | 36 | Beast | Weak->Ley, Resist->Storm | +Storm Breath (cone AoE), +Wingbeat (knockback), +Roar (ATK up) | Rare |
| 4 | Pallor Drake | 50 | Pallor | Weak->Spirit, Resist->Void | +Despair Breath (cone AoE Despair), +Corrupted Frenzy (3-hit), +Rend (DEF down) | Rare |
...
**Base:** Marsh Serpent (Lv 6, Beast, Low)
**Planned Tiers:** 4
...
> remain Beast-type throughout, growing more obnoxious but never
> reaching Pallor corruption.

---

## Lurker Family

**Base:** Swamp Lurker (Lv 8, Beast, Standard)
**Planned Tiers:** 4
...
**Base:** Ley Jellyfish (Lv 8, Elemental, Standard)
**Planned Tiers:** 3

| Tier | Name | Lv | Type | Element Shift | New Abilities | Threat |
|------|------|----|------|---------------|---------------|--------|
| 1 | Ley Jellyfish | 8 | Elemental | — | Ley Sting (Paralysis chance), Drift (random target) | Standard |
...
> Jellyfish are status-inflicting Elementals focused on Paralysis.
> They shift element across tiers like Wisps. Three tiers -- they
> stay Elemental throughout.

---

## Elemental Family

**Base:** Polluted Elemental (Lv 9, Elemental, Standard)
**Planned Tiers:** 3
...
**Base:** Plains Hare (Lv 1, Beast, Trivial)
**Planned Tiers:** 2
...
**Base:** Thornback Beetle (Lv 3, Beast, Low)
**Planned Tiers:** 3
...
> across tiers -- punishing careless physical attackers. Three tiers
> keeps them as durable mid-tier threats.

---

## Bandit Family

**Base:** Road Bandit (Lv 4, Humanoid, Low)
**Planned Tiers:** 4
...
**Base:** Forest Sprite (Lv 4, Spirit, Low)
**Planned Tiers:** 3
...
**Base:** Wild Boar (Lv 5, Beast, Standard)
**Planned Tiers:** 3
...
**Base:** Wayward Wolf (Lv 6, Beast, Standard)
**Planned Tiers:** 4
...
> Wolves are pack hunters -- always encountered in groups. Their howl
> abilities buff the entire pack, making the encounter harder the longer
...
>
> **Act III early deployment:** Pallor Regent (Tier 3) is deployed at
> Lv 34 in overworld grey zones (projected Lv 46). Stats in act-iii.md
> are computed from the deployment level.

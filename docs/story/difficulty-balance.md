# Difficulty & Balance Framework

> Canonical balance document for Pendulum of Despair. Defines the
> target difficulty, combat pacing, resource management, progression
> curve, anti-frustration features, and validation methodology.
>
> **Philosophy:** FF6 Accessible. Combat serves the story. One fixed
> difficulty. The Pallor is the emotional challenge, not the mechanics.
...
(per [combat-formulas.md](combat-formulas.md) § Fight Duration
Targets). AoE magic clears groups efficiently. The ATK²/6 formula
scales quadratically, so well-equipped physical attackers trend
toward the lower end (2 hits), while support characters need 3–4.
...
AoE magic. This matches FF6 pacing and aligns with combat-formulas.md's
"2–4 hits from primary attacker" target.

**When enemies take 3–4 hits:** Back attacks, Pallor Wastes (higher-
tier enemies), dungeon deep floors, underleveled party. These create
pacing variety without frustration.
...
to same-level regular enemies. The player is always "higher level"
than bosses but faces equivalent challenge through boss mechanics.

### 4.2 Catch-Up Mechanics

Per [progression.md](progression.md):
...
vs Load" menu — the reload is instant and automatic.
...
Per [combat-formulas.md](combat-formulas.md):
...
Per [events.md](events.md) § Faint and Fast Reload:
...
See [combat-formulas.md](combat-formulas.md) for full formulas
including variance, critical hits, elemental multipliers, and
multi-hit splitting.

### 7.2 Boss Duration Check

For any boss, estimate fight duration using the ATB system (no
discrete rounds — each party member acts independently when their
gauge fills):
...
See [combat-formulas.md](combat-formulas.md) § Encounter System for
danger counter increments per terrain type.
...
| System | Reference |
|--------|-----------|
| Physical damage | [combat-formulas.md](combat-formulas.md) § Physical Damage |
| Magic damage | [combat-formulas.md](combat-formulas.md) § Magic Damage |
| Stat growth | [progression.md](progression.md) § Character Growth |
| XP curve | [progression.md](progression.md) § Two-Phase XP Curve |
| Enemy stats | [bestiary/](bestiary/) (act-i.md through act-iii.md) |
| Boss stats | [bestiary/bosses.md](bestiary/bosses.md) |
| Equipment tiers | [equipment.md](equipment.md) § Weapons |
| Economy/gold | [economy.md](economy.md) § Gold Pacing Targets |
| Encounter rates | [combat-formulas.md](combat-formulas.md) § Encounter System |
| ATB timing | [combat-formulas.md](combat-formulas.md) § ATB Gauge System |

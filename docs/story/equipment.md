...
| Cael's Edge | Current weapon ATK +20 | — | Spirit | Sever Bond: 1-use 3.0× ability ignoring DEF (Vaelith fight only) | — | 5 | `trial_lira_complete` (Pallor Wastes trial, manifests at Vaelith fight) |

...
- **Act:** **II — this is the canonical assignment (#287).** The dungeon is unreachable in Act I: Duskfen opens only on `diplomatic_mission_start` ([events.md](events.md) flag 8, listed under Act II Flags, and again in the Act II "New Areas Opening" list), and flag 8 can only fire after `pendulum_to_capital` (flag 6), the event whose own entry reads "Act I ends. Act II begins." [outline.md](outline.md) § The Diplomatic Mission makes the same sequence explicit, listing "clear Fenmother's Hollow" as step 1 of three. Reachability settles it; nothing proposes a way in before the diplomatic mission. Several docs nevertheless *tune* it as Act I content — the roster sits in `game/data/enemies/act_i.json` at Lv 6-12 with a Lv 12 boss, [bestiary/act-i.md](bestiary/act-i.md) hosts its stat table, and [economy.md](economy.md) § Act I counts the Fenmother's boss gold. That is a power-band statement, not an act assignment: the dungeon is the *first* content of Act II and is deliberately pitched at the ceiling of Act I's curve. Where a doc says "Act I" about this dungeon it is stale, not a competing reading.

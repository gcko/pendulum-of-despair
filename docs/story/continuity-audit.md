...
| **"The Third Door" references Dry Well of Aelhart** | **MINOR** | The quest sends the party to the Dry Well of Aelhart. locations.md says the Dry Well dungeon (7 floors) is "Only accessible during or after the Interlude." The quest is available during the Interlude, so this is consistent. |
